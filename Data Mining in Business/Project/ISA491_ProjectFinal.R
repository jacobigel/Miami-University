dir()
setwd('\\Users\\igeljj\\Desktop\\Project')
...
domestic <-select(domestic, -starts_with("TIB"), -starts_with("TOEFL"),
                  ...
                  -ends_with("tag"),-"VentureScholar", -"RoundedGPA",
...
final_miss <- plot_missing(domestic)
final_bar <- plot_bar(domestic)
final_hist <- plot_histogram(domestic)
