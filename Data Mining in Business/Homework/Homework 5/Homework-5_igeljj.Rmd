...
The xgboost would be the best moving forwards since it has the lowest difference in AUC values between the training and validation (it is not too overfit) which means that it will do a better job at predicting other samples.
